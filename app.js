...
const getPokemon = async (id) => {
  ...
  cretePokemonCard(data);
};

const cretePokemonCard = (pokemon) => {
  ...
  <div class="small">
    <small class="poke-exp"><i class="fa solid fa-flask"></i> ${pokemon.base_experience} XP</small>
